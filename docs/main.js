...
var $author$project$Main$Model = F2(
	function (content, fontSize) {
		return {J: content, D: fontSize};
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A2($author$project$Main$Model, 'Start typing...', 100),
				...
				_Utils_update(
					model,
					{
						D: A2(
							...
							100,
							$elm$core$String$toInt(fontSize))
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$formatWord = function (word) {
	var wordLength = $elm$core$String$length(
		A2(
			...
			return _List_fromArray(
				[
					...
					$elm$core$List$singleton(
						$elm$html$Html$text(
							A2($elm$core$String$left, 1, word)))),
					$elm$html$Html$text(
					A2($elm$core$String$right, 1, word))
				]);
		case 3:
			return _List_fromArray(
				[
					...
					$elm$core$List$singleton(
						$elm$html$Html$text(
							A2($elm$core$String$left, 1, word)))),
					$elm$html$Html$text(
					A2($elm$core$String$right, 2, word))
				]);
		case 4:
			return _List_fromArray(
				[
					...
					$elm$core$List$singleton(
						$elm$html$Html$text(
							A2($elm$core$String$left, 2, word)))),
					$elm$html$Html$text(
					A2($elm$core$String$right, 2, word))
				]);
		default:
			var midle = $elm$core$Basics$floor((wordLength * 3) / 5);
			return _List_fromArray(
				[
					A2(
					$elm$html$Html$b,
					...
					$elm$core$List$singleton(
						$elm$html$Html$text(
							A2($elm$core$String$left, midle, word)))),
					$elm$html$Html$text(
					A2(
						$elm$core$String$right,
						$elm$core$String$length(word) - midle,
						word))
				]);
	}
};
var $author$project$Main$whiteSpace = $elm$html$Html$text(' ');
...
var $author$project$Main$wordStartWithNumber = function (word) {
	return A2(
		$elm$core$List$any,
		function (c) {
			return A2($elm$core$String$startsWith, c, word);
		},
		A2(
			$elm$core$List$map,
...
var $author$project$Main$formatWordAndAddWhiteSpace = function (word) {
	var formatedWord = $author$project$Main$wordStartWithNumber(word) ? _List_fromArray(
		[
			$elm$html$Html$text(word)
		]) : $author$project$Main$formatWord(word);
	return A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Bionic Reading Elm')
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onInput($author$project$Main$UpdateFontSize),
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Insert Text:')
									])),
								A2(
								$elm$html$Html$textarea,
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$style, 'min-height', '30vh'),
										$elm$html$Html$Events$onInput($author$project$Main$UpdateContent),
										$elm$html$Html$Attributes$placeholder(model.J)
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Main$contentView(model.J)
									]))
							]))
					]))
			]));
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{aB: $author$project$Main$init, aL: $author$project$Main$subscriptions, aN: $author$project$Main$update, aO: $author$project$Main$view});
